...
nv.models.pie = function() {
  ...
  function chart(selection) {
    selection.each(function(data) {
      ...
      var ae = slices.enter().append('g')
        ...
        d3.transition(slices.select('path.donut-arc'))
            .attr('d', arc)
        ...
        if (showLabels) {
          ...
          ae.insert("g", 'path.donut-arc').classed("nv-label", true)
            .each(function(d, i) {
          ...
          slices.each(function(d, i) {
              ...
              .select(".nv-label text")
                ...
                .text(function(d, i) {
                  ...
                  var labelTypes = {
                    ...
                    "custom1": getX(d.data).toUpperCase() + ' ' + d3.format('%')(percent)
                  };
            ...
            var line = d3.svg.line()
                          ...
                          .interpolate('linear');
            slice.select('.nv-label path')
                .attr('d', line(getPathData(d)));
          });
        }
  ...
  chart.arcRadius = function(_) {
    if (!arguments.length) return arcRadius;
    arcRadius = _;
    return chart;
  };
...
nv.models.pieChart = function() {
  ...
  d3.rebind(chart, pie, 'valueFormat', 'values', 'x', 'y', 'description', 'id', 'showLabels', 'donutLabelsOutside', 'pieLabelsOutside', 'labelType', 'donut', 'donutRatio', 'spacing', 'labelOverhang', 'labelOffset', 'arcRadius', 'labelThreshold');
